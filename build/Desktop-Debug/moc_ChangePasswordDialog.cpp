...
namespace {
struct qt_meta_tag_ZN20ChangePasswordDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN20ChangePasswordDialogE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20ChangePasswordDialogE[] = {
...
Q_CONSTINIT const QMetaObject ChangePasswordDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20ChangePasswordDialogE.offsetsAndSizes,
    qt_meta_data_ZN20ChangePasswordDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20ChangePasswordDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void ChangePasswordDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_changeButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *ChangePasswordDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20ChangePasswordDialogE.stringdata0))
