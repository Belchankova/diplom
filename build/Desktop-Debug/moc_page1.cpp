...
namespace {
struct qt_meta_tag_ZN5Page1E_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN5Page1E = QtMocHelpers::stringData(
    "Page1"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5Page1E[] = {
...
Q_CONSTINIT const QMetaObject Page1::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5Page1E.offsetsAndSizes,
    qt_meta_data_ZN5Page1E,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5Page1E_t,
        // Q_OBJECT / Q_GADGET
...
void *Page1::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5Page1E.stringdata0))
