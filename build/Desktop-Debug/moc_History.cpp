...
static constexpr auto qt_meta_stringdata_ZN7HistoryE = QtMocHelpers::stringData(
    "History",
    "reload",
    "",
    "exportToPdf"
...
Q_CONSTINIT static const uint qt_meta_data_ZN7HistoryE[] = {
...
Q_CONSTINIT const QMetaObject History::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7HistoryE.offsetsAndSizes,
    qt_meta_data_ZN7HistoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7HistoryE_t,
        // Q_OBJECT / Q_GADGET
...
void *History::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7HistoryE.stringdata0))
